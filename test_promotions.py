...
def test_percent_discount():
    ...
    product.set_promotion(PercentDiscount("30% off", 30))
...
def test_same_promotion_can_be_shared_by_products():
    ...
    first_product.set_promotion(promotion)
    second_product.set_promotion(promotion)

    assert first_product.get_promotion() is promotion
    assert second_product.get_promotion() is promotion
